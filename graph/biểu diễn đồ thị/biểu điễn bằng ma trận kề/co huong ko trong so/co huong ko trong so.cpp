...
/// đồ thị có hướng ko trọng soo n đỉnh
ll n, m;
...
signed main() {
    ...
    forr(i, 1, m, 1) { /// m cạnh liên thông
        ll u, v; cin >> u >> v; /// đỉnh u liên thông đến đỉnh v
        dothi[u][v] = 1; /// từ tỉnh u đến đc đỉnh v
        /// dothi[i][j] == 1 tức là có cạnh liên thông hướng i đến j
