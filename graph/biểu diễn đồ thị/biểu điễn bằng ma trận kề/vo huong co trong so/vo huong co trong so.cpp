...
signed main() {
    ...
    forr(i, 1, m, 1) { /// m cạnh liên thông
        ll u, v, value; cin >> u >> v >> value; /// đỉnh u liên thông đến đỉnh v trọng số c(u, v) = value
        dothi[u][v] = dothi[v][u] = value; /// từ tỉnh u đến đc đỉnh v trọng số c(u, v) = vaule
        /// dothi[i][j] == value tức là có cạnh liên thông i đến j và j đến i trọng số c(u, v) = value
