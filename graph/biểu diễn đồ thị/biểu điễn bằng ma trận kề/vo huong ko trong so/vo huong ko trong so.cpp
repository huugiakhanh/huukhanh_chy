...
/// đồ thị vô hướng ko trọng số n đỉnh
ll n, m;
...
signed main() {
    ...
    forr(i, 1, m, 1) { /// m cạnh liên thông
        ll u, v; cin >> u >> v; /// đỉnh u liên thông đỉnh v
        dothi[u][v] = dothi[v][u] = 1; /// từ tỉnh u đến đc đỉnh v và ngược lại
        /// dothi[i][j] == 1 tức là có cạnh liên thông
        /// dothi[i][j] == 1 tức là ko cạnh liên thông
    }
    forr(i, 1, n, 1) {
        forr(j, 1, n, 1) {
            cout << dothi[i][j] << " ";
